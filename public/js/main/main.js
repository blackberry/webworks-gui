...
function xmlLoad(){
    xml = getProjectsXML();
        $(xml).find('project').each(function(){
            project = $(this);
            $("#list-projects").append('<li class="project-list" data-path="'+project.attr("path")+'"><a href="#" data-page="info.html" class="project-name-info">'+project.attr("id")+'</a><div class="delete-btn" data-projectid="'+project.attr("id")+'" data-page="project_delete.html"></div></li>');
