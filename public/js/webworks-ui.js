...
define('lib/ui/views/projectList',['require','exports','module'],function (require, exports, module) {
var ProjectListView = Backbone.View.extend({
    ...
    render: function () {
        var template = _.template($('#project_list_template').html(),{projects: this.model.models});
...
define('lib/ui/views/projectCreate',['require','exports','module'],function (require, exports, module) {
...
ProjectCreateView = Backbone.View.extend({
    ...
    render: function () {
        var template = _.template($('#project_create_template').html(), {});
        this.$el.html(template);
    },
    events: {
    ...
    createProject: function () {
        var projectListView = window.views["projectList"];
        nameInput = $("#txtProjectName");
        pathInput = $("#txtProjectPath");
        projectListView.model.create({
            name: nameInput.val(),
            location: pathInput.val()
        });
    }
});
...
define('lib/ui/server',['require','exports','module'],function (require, exports, module) {
var server,
    baseUrl = "/";
...
define('lib/ui/models/project',['require','exports','module','../server'],function (require, exports, module) {
...
define('lib/ui/collections/projectList',['require','exports','module','../models/project'],function (require, exports, module) {
var ProjectList,
...
define('lib/ui/main',['require','exports','module','./views/projectList','./views/projectCreate','./collections/projectList','./models/project'],function (require, exports, module) {
