...
ProjectCreateView = Backbone.View.extend({
    initialize: function () {
        ...
        $(".new-project").on("mouseover", this.onMouseOver);
        $(".new-project").on("mouseout", this.onMouseOut);
    ...
    display: function () {
        window.views.projectList.setActiveProject(undefined);
        this.render();
    },
    events: {
    ...
    onMouseOver : function(e){
        $("#tooltip").attr('class', 'myshowedtooltip');
    },
