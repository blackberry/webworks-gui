...
var View,
    viewTemplate,
    ProxyNotificationView = require("./proxyNotification");

function renderSubviews(model) {
    window.views.proxyNotification.setElement($("#proxyNotificationPanel"));
    window.views.proxyNotification.display(window.views.globalSettings.model);
}
...
View = Backbone.View.extend({
    initialize: function () {
        ...
        window.views.proxyNotification = new ProxyNotificationView();
    },
    render: function () {
        var view = this;
    ...
    events: {
        ...
        "click #downloadTokenBtn" : "openDownloadTokenPage"
    },
    ...
    openDownloadTokenPage: function (event) {
        window.open("http://developer.blackberry.com/codesigning");
    },
