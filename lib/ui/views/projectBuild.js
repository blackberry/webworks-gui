...
ProjectBuildView = Backbone.View.extend({
    ...
    render: function () {
        ...
        this.model.getBB10Config(function (response) {
            template = _.template(projectBuildTemplate, {
                buildSettings: view.model.get("buildSettings") || {device: false, debug: true},
    ...
    updateDropDown: function () {
        ...
        window.views.targetSelector.showOnlySimulators = $("#targetType input:radio:checked").val() === "simulator";
